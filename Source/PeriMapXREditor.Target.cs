...
public class PeriMapXREditorTarget : TargetRules
{
    public PeriMapXREditorTarget(TargetInfo Target) : base(Target)
    {
        Type = TargetType.Editor;
        DefaultBuildSettings = BuildSettingsVersion.V4; // Use the latest build settings
